...
This script allows you to avoid that. It will list all drives to be ejected and prompt
you for confirmation before unmounting them with `diskutil`.

<Callout type="danger">
If you've renamed your internal HD, you will need to update the variable in
the script! \
Otherwise you may eject your internal hard drive...
</Callout>
